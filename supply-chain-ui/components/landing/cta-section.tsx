					...
					<div className='relative flex flex-col justify-center items-center w-full overflow-hidden'>
						...
						<div className='z-10 absolute'>
							...
							<div className='z-10 flex flex-col items-center mt-4 text-center text-white'>
								...
								<p className='mt-2'>
									Your own Inventory Management System
								</p>
								<Link
									href='/signup'
									className={cn(
							...
							<div className='-z-10 absolute inset-0 bg-background opacity-40 blur-xl rounded-full' />
						</div>
						<div className='bottom-0 absolute inset-x-0 bg-gradient-to-b from-transparent to-70% to-background h-full' />
					</div>
				</div>
			</div>
		</section>
